...
void setup() {
  ...
  radar2 = new RadarChartv2(750, 290, 500, 230, controller, table, new String[]{"hp", "attack", "defense", "spattack", "spdefense", "speed"});
  ...
  layout.addCharts(new Chart[]{scatter, histo, radar2});
  controller.addViews(new View[]{pokedex, scatter, histo, pies, radar2});
